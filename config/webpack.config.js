...
module.exports = function (webpackEnv) {
  ...
  return {
    ...
    resolve: {
      // This allows you to set a fallback for where webpack should look for models.
      ...
      rules: [
        ...
        { parser: { requireEnsure: false } },
        {
          ...
          oneOf: [
            ...
            // "style" loader turns CSS into JS models that inject <style> tags.
            ...
            // This loader doesn't use a "test" so it will catch all models
    ...
    // Some libraries import Node models but don't use them in the browser.
